        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-12 mb-16 pb-16 border-b border-slate-800">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/support" className="text-slate-400 hover:text-white transition-colors duration-200">
                  Contact Us
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/shipping-policy" className="text-slate-400 hover:text-white transition-colors duration-200">
                  Shipping Policy
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/terms-of-service" className="text-slate-400 hover:text-white transition-colors duration-200">
                  Terms of Service
                </Link>
              </li>
            </ul>
