          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl">
              ...
              <div className="p-6 bg-white rounded-2xl border border-[var(--brand-blue-light)]/20 hover:shadow-md transition-shadow">
                ...
                <h3 className="font-bold text-foreground mb-2 text-center">Care Guide</h3>
                <p className="text-sm text-foreground/70 mb-4 text-center">Learn how to care for your Kuddles</p>
                <Button variant="outline" size="sm" className="w-full bg-transparent" asChild>
                  <Link href="/care-guide">Learn More</Link>
                </Button>
              </div>
              ...
              <div className="p-6 bg-white rounded-2xl border border-[var(--brand-blue-light)]/20 hover:shadow-md transition-shadow">
                ...
                <h3 className="font-bold text-foreground mb-2 text-center">Need Help?</h3>
                <p className="text-sm text-foreground/70 mb-4 text-center">Contact our support team</p>
                <Button variant="outline" size="sm" className="w-full bg-transparent" asChild>
