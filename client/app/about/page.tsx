        ...
        <section className="py-20 md:py-28">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <Card className="p-10 md:p-16 border border-[var(--brand-blue-light)] rounded-3xl bg-white shadow-lg">
                <div className="space-y-6">
                  <div className="text-center mb-8">
                    <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
                      A Message from the Kuddles Community
                    </h2>
                  </div>

                  <p className="text-lg md:text-xl text-foreground/70 leading-relaxed text-pretty text-center">
                    {communityMessage}
                  </p>

                  <div className="pt-8 border-t border-[var(--brand-blue-light)]/30">
                    <p className="text-sm text-foreground/60 font-medium uppercase tracking-widest mb-6 text-center">
                      What drives us
                    </p>
