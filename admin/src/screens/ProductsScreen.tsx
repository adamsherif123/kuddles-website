  ...
  async function onSubmit() {
    ...
    try {
      ...
      const basePayload: NewProductInput = {
        ...
        isActive: true, // Always active, use delete to remove
      };
                ...
                <View style={styles.rowTop}>
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={styles.productMeta}>
                      {currency(p.price)} • {(p.sizes?.length ?? 0)} sizes
                    </Text>
                  </View>
...
const styles = StyleSheet.create({
  ...
  deleteBtn: { backgroundColor: '#DC2626', paddingVertical: 10, paddingHorizontal: 14, borderRadius: 12, minWidth: 120, alignItems: 'center', justifyContent: 'center' },
